    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-900/40 backdrop-blur-sm">
      <div className="w-[360px] rounded-lg bg-white px-5 py-4 shadow-2xl">
        ...
        <div className="h-2.5 w-full overflow-hidden rounded-full bg-[#E2E8F0]">
          <div className="h-full rounded-full bg-[#EEEDFE]0 transition-all duration-300" style={{ width: `${Math.max(pct, 8)}%` }} />
        </div>
        <div className="mt-2 text-[11px] text-[#94A3B8]">창이나 브라우저를 만지지 말아주세요</div>
      </div>
    </div>
  )
}
